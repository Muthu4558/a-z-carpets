...
const Ag50 = () => {
  ...
  /* ================= FETCH 35MM ARTIFICIAL GRASS ================= */
  useEffect(() => {
    startLoading();
    axios
      .get(
        `${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?productGroup=artificial_grass&thickness=50MM`
      )
      .then((res) => {
    ...
    <>
      ...
      <section className="bg-white pt-28 pb-16 text-center">
        <h1 className="text-4xl font-bold">
          50MM <span className="text-[#D4AF37]">Artificial Grass</span>
        </h1>
        <p className="mt-3 text-gray-500">
          Premium 35MM thick artificial grass for landscaping,
          ...
          <div className="bg-[#111111] rounded-2xl p-6 shadow-lg">
            ...
            <div className="grid md:grid-cols-4 gap-6 items-center">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search artificial grass..."
                  value={searchTerm}
          ...
          {loading ? (
            ...
            <div className="text-center py-24">
              <h3 className="text-2xl font-semibold">
                No 50MM Artificial Grass Found
              </h3>
