...
const BlackCarpets = () => {
    ...
    useEffect(() => {
        startLoading();
        axios
            .get(`${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?color=black`)
            .then((res) => {
        ...
        <>
            ...
            <section className="bg-white pt-28 pb-16 text-center">
                <h1 className="text-4xl font-bold">
                    Black <span className="text-[#D4AF37]">Carpets</span>
                </h1>
                <p className="mt-3 text-gray-500">
                    Elegant black carpets for sophisticated interiors.
                </p>
            </section>
