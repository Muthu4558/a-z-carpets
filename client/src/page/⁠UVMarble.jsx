...
const Marble = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(
                `${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?category=UV Marble Sheet Self Adhesive`
            )
            .then((res) => {
        ...
        <>
            ...
            <section className="bg-white pt-28 pb-16 text-center">
                <h1 className="text-4xl font-bold">
                    UV Marble<span className="text-[#D4AF37]"> Sheet Self Adhesive</span>
                </h1>
                <p className="mt-3 text-gray-500">
                    Premium UV Marble Sheet Self Adhesive.
                </p>
            </section>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-24">
                            <h3 className="text-2xl font-semibold">
                                No UV Marble Sheet Self Adhesive Found
                            </h3>
                        ...
                        <div className="text-center py-24">
                            <h3 className="text-2xl font-semibold mb-4">
                                No UV Marble Sheet Self Adhesive Match Your Filters
                            </h3>
                            <button
                                onClick={clearFilters}
