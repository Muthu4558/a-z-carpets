...
const WPC = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(
                `${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?category=Wpc Fluted Pannel`
            )
            .then((res) => {
        ...
        <>
            ...
            <section className="bg-white pt-28 pb-16 text-center">
                <h1 className="text-4xl font-bold">
                    WPC<span className="text-[#D4AF37]"> Fluted Pannel</span>
                </h1>
                <p className="mt-3 text-gray-500">
                    Premium WPC Wpc Fluted Pannel.
                </p>
            </section>
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-24">
                            <h3 className="text-2xl font-semibold mb-4">
                                No Wpc Fluted Pannel Match Your Filters
                            </h3>
                            <button
                                onClick={clearFilters}
