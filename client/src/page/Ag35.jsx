...
const Ag35 = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?productGroup=artificial_grass&thickness=35MM`
      )
      .then((res) => {
    ...
    <>
      ...
      <section className="bg-white pt-28 pb-16 text-center">
        <h1 className="text-4xl font-bold">
          35MM <span className="text-[#D4AF37]">Artificial Grass</span>
        </h1>
          ...
          {loading ? (
            ...
            <div className="text-center py-24">
              <h3 className="text-2xl font-semibold">
                No 35MM Artificial Grass Found
              </h3>
