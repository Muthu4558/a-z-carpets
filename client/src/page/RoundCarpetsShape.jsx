...
const RoundCarpets = () => {
    ...
    /* ================= FETCH ROUND PRODUCTS ================= */
    useEffect(() => {
        startLoading();
        axios
            .get(`${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?shape=round`)
            .then((res) => {
        ...
        <>
            ...
            <section className="bg-white pt-28 pb-16 text-center">
                <h1 className="text-4xl font-bold">
                    Round <span className="text-[#D4AF37]">Carpets</span>
                </h1>
                <p className="mt-3 text-gray-500">
                    Stylish round carpets for modern interiors.
                </p>
            </section>
