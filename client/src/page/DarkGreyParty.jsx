...
const DarkGreyParty = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(
                `${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?category=Dark Grey Party Carpets`
            )
            .then((res) => {
        ...
        <>
            ...
            <section className="bg-white pt-28 pb-16 text-center">
                <h1 className="text-4xl font-bold">
                    Dark Grey <span className="text-[#D4AF37]">Party Carpets</span>
                </h1>
                <p className="mt-3 text-gray-500">
                    Premium dark grey carpets specially designed for events,
                    ...
                    {loading ? (
                        ...
                        <div className="text-center py-24">
                            <h3 className="text-2xl font-semibold">
                                No Dark Grey Party Carpets Found
                            </h3>
