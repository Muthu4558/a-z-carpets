...
const Size8x11 = () => {
  ...
  useEffect(() => {
    startLoading();
    axios
      .get(`${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?size=8x11ft`)
      .then((res) => {
    ...
    <>
      ...
      <section className="bg-white pt-28 pb-16 text-center">
        <h1 className="text-4xl font-bold">
          8x11ft <span className="text-[#D4AF37]">Carpets</span>
        </h1>
