...
const RedParty = () => {
    ...
    useEffect(() => {
        ...
        axios
            .get(
                `${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?category=Red Party Carpets`
            )
            .then((res) => {
        ...
        <>
            ...
            <section className="bg-white pt-28 pb-16 text-center">
                <h1 className="text-4xl font-bold">
                    Red <span className="text-[#D4AF37]">Party Carpets</span>
                </h1>
                <p className="mt-3 text-gray-500">
                    Premium red carpets specially designed for events,
