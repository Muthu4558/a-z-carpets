...
const RoundTufted = () => {
    ...
    useEffect(() => {
        startLoading();
        axios
            .get(`${import.meta.env.VITE_APP_BASE_URL}/api/products/filter?category=Round Tufted Carpets`)
            .then((res) => {
        ...
        <>
            ...
            <section className="bg-white pt-28 pb-16 text-center">
                <h1 className="text-4xl md:text-5xl font-bold text-black">
                    Premium <span className="text-[#D4AF37]">Round Tufted Carpets</span>
                </h1>
